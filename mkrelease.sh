...
cp $DIR/output/raspberrypi2/target/usr/lib/libx264.so.148 $DIR/releases/rpi4/$DATE/rpi2-libx264.so.148
...
cp $DIR/output/raspberrypi3/target/usr/lib/libx264.so.148 $DIR/releases/rpi4/$DATE/rpi3-libx264.so.148
