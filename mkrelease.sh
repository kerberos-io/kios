...
cd $DIR/output/raspberrypi/target/var/www/web && rm -rf app/storage && mkdir -p app/storage/cache && mkdir -p app/storage/logs && mkdir -p app/storage/meta && mkdir -p app/storage/sessions && mkdir -p app/storage/views && sed -i 's/memcached/file/g' app/config/app.php && sed -i 's/\/data\/machinery\/config/\/\etc\/opt\/kerberosio\/config/g' app/config/app.php && sed -i 's/\/data\/web/\_\_DIR\_\_\.\'\/\.\.\/app\'/g' && tar czf $DIR/releases/rpi/$DATE/web.tar.gz .
...
cd $DIR/output/raspberrypi2/target/var/www/web && rm -rf app/storage && mkdir -p app/storage/cache && mkdir -p app/storage/logs && mkdir -p app/storage/meta && mkdir -p app/storage/sessions && mkdir -p app/storage/views && sed -i 's/memcached/file/g' app/config/app.php  && sed -i 's/\/data\/machinery\/config/\/\etc\/opt\/kerberosio\/config/g' app/config/app.php && sed -i 's/\/data\/web/\_\_DIR\_\_\.\'\/\.\.\/app\'/g' && tar czf $DIR/releases/rpi2/$DATE/web.tar.gz .
...
cd $DIR/output/raspberrypi3/target/var/www/web && rm -rf app/storage && mkdir -p app/storage/cache && mkdir -p app/storage/logs && mkdir -p app/storage/meta && mkdir -p app/storage/sessions && mkdir -p app/storage/views && sed -i 's/memcached/file/g' app/config/app.php && sed -i 's/\/data\/machinery\/config/\/\etc\/opt\/kerberosio\/config/g' app/config/app.php && sed -i 's/\/data\/web/\_\_DIR\_\_\.\'\/\.\.\/app\'/g' && tar czf $DIR/releases/rpi3/$DATE/web.tar.gz .